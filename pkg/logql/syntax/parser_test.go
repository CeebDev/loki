...
func TestParseSampleExpr_String(t *testing.T) {
	longQuery := `sum(rate({cluster="us-central2", namespace="loki-prod"} |= "rpc error: code = Canceled desc = grpc: the client connection is closing" | logfmt | msg=~` + "`" + `.*?(GET|POST|PUT|DELETE|PATCH|HEAD|OPTIONS) /loki/api/(?i)(\d+[a-z]|[a-z]+\d)\w*/query_range\?direction=BACKWARD&end=(\d+)&limit=(\d+)&query=count_over_time%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*(?i)\d*\.?\d+(ms|s|m)_namespace_name%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-prometheus%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*\+%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+forbidden%(?i)(\d+[a-z]|[a-z]+\d)\w*\+exceeded\+quota%(?i)(\d+[a-z]|[a-z]+\d)\w*\+resource-quota%(?i)(\d+[a-z]|[a-z]+\d)\w*\+requested%(?i)(\d+[a-z]|[a-z]+\d)\w*\+pods%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+json\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+__error__%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+event_reason%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+event_involvedObject_name%(?i)(\d+[a-z]|[a-z]+\d)\w*~%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-fA-(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*-fA-(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\.%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*(?i)\d*\.?\d+(ms|s|m)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)&shards=(\d+)_of_(\d+)&start=(\d+)&step=(?i)(/?([\w-]+))+\.([\w]{2,4})(\d+) \((\d+)\) (?i)\d*\.?\d+(ms|s|m) Response: "rpc error: code = Canceled desc = grpc: the client connection is closing\\n" ws: false; X-Query-Queue-Time: (?i)\d*\.?\d+(ms|s|m); X-Query-Tags: source=grafana-alert; X-Scope-Orgid: (\d+); uber-trace-id: (?i)(\d+[a-z]|[a-z]+\d)\w*:(?i)(\d+[a-z]|[a-z]+\d)\w*:(?i)(\d+[a-z]|[a-z]+\d)\w*:(\d+);.*` + "`" + `[1d]))`
	require.True(t, len(longQuery) < 5120)
	longExpr, longErr := ParseSampleExpr(longQuery)
	require.NoError(t, longErr)
	// need remove some backticks that get changed during parsing
	longQuery = `sum(rate({cluster="us-central2", namespace="loki-prod"} |= "rpc error: code = Canceled desc = grpc: the client connection is closing" | logfmt | msg=~.*?(GET|POST|PUT|DELETE|PATCH|HEAD|OPTIONS) /loki/api/(?i)(\d+[a-z]|[a-z]+\d)\w*/query_range\?direction=BACKWARD&end=(\d+)&limit=(\d+)&query=count_over_time%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*(?i)\d*\.?\d+(ms|s|m)_namespace_name%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-prometheus%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*\+%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+forbidden%(?i)(\d+[a-z]|[a-z]+\d)\w*\+exceeded\+quota%(?i)(\d+[a-z]|[a-z]+\d)\w*\+resource-quota%(?i)(\d+[a-z]|[a-z]+\d)\w*\+requested%(?i)(\d+[a-z]|[a-z]+\d)\w*\+pods%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+json\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+__error__%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+event_reason%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\+%(?i)(\d+[a-z]|[a-z]+\d)\w*\+event_involvedObject_name%(?i)(\d+[a-z]|[a-z]+\d)\w*~%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-fA-(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)w*%(?i)(\d+[a-z]|[a-z]+\d)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*-fA-(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*-%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*-(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)\.%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)%(\d+)%(?i)(\d+[a-z]|[a-z]+\d)\w*(?i)\d*\.?\d+(ms|s|m)%(?i)(\d+[a-z]|[a-z]+\d)\w*%(\d+)&shards=(\d+)_of_(\d+)&start=(\d+)&step=(?i)(/?([\w-]+))+\.([\w]{2,4})(\d+) \((\d+)\) (?i)\d*\.?\d+(ms|s|m) Response: "rpc error: code = Canceled desc = grpc: the client connection is closing\\n" ws: false; X-Query-Queue-Time: (?i)\d*\.?\d+(ms|s|m); X-Query-Tags: source=grafana-alert; X-Scope-Orgid: (\d+); uber-trace-id: (?i)(\d+[a-z]|[a-z]+\d)\w*:(?i)(\d+[a-z]|[a-z]+\d)\w*:(?i)(\d+[a-z]|[a-z]+\d)\w*:(\d+);.*[1d]))`
	require.Equal(t, longQuery, longExpr.String())
}
